...
<br/>위는 ACES의 컬러스페이스다.
<br/><br/>**ACES 2065-1** - 사람의 눈보다 넓은 범위의 범위의 Linear, 색 공간이므로 보관용 복사 및 부서 간 자료 전송에 사용된다.
...
<br/><br/>변환을 위한 주요 색상 공간은 다음과 같다.
<br/>**Scene-linear Rec.709-sRGB**  - Rec.709 또는 sRGB 기본/색영역을 사용하는 선형 이미지에 대해 선택한다.
